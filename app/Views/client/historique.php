...
<head>
    ...
    <style>
        ...
        th, td { padding: .85rem; border-bottom: 1px solid #ddd; text-align: left; }
...
<body>
    ...
    <main>
        <div class="card">
            ...
            <p>Les opérations récentes s'afficheront ici lorsque la fonctionnalité sera connectée au contrôleur et au modèle.</p>
            <table>
                <thead>
                    <tr>
                        <th>Date</th>
